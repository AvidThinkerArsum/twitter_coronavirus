        ...
        with archive.open(filename) as f:
            ...
            for line in f:
                ...
                for hashtag in hashtags:
                    ...
                    # determine the lang for the text
                    lang = tweet['lang']
                    
                    # Instead of directly chaining `.get()`, first ensure 'place' is a dictionary
                    place_info = tweet.get('place') or {}  # This ensures place_info is a dictionary even if tweet.get('place') is None
                    country_code = place_info.get('country_code', 'unknown')
